...
export const locations: Location[] = [
  { 
    ...
    description: 'Experience the thrill at Wonderla Kochi, featuring over 50+ exciting rides and attractions.'
  },
  { 
    name: 'Bengaluru', 
    adultPrice: 2200,
    image: 'https://www.prestigesouthernstar.info/images/prestige/wonderla-amusement-park.webp  ',
    description: 'Visit our flagship park in Bengaluru with state-of-the-art rides and water attractions.'
  },
  { 
    name: 'Hyderabad', 
    adultPrice: 2000,
    image: 'https://www.prestigesouthernstar.info/images/prestige/wonderla-bengaluru.webp',
    description: 'Discover endless fun at Wonderla Hyderabad with thrilling rides for all ages.'
  },
  { 
    name: 'Bhubaneswar', 
    adultPrice: 1500,
    image: 'https://budgetindianvacations.wordpress.com/wp-content/uploads/2015/11/wonderla-amusement-park-karnataka.jpg',
    description: 'Our newest destination featuring modern attractions and family entertainment.'
  },
];
...
const BookingPage: React.FC = () => {
  ...
  const validateBooking = () => {
    ...
    if (!userInfo.name || !userInfo.email || !userInfo.mobile || !userInfo.pinCode || !userInfo.termsAccepted) {
    ...
    <Box className="min-h-screen bg-gray-50">
      ...
      >
        <Box sx={{
          ...
          <Typography variant="h6" component="span" sx={{ mx: 4, opacity: 0.7 }}>
            |
          </Typography>
          <Typography variant="h6" component="span" sx={{ mx: 4 }}>
